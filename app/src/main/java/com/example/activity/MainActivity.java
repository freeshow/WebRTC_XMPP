...
public class MainActivity extends ParentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListViewFriend.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String friendNickname = mFriendListAdapter.getNickname(position);
        ...
        public void chatCreated(Chat chat, boolean b) {
            chat.addMessageListener(new ChatMessageListener() {
                ...
                public void processMessage(Chat chat, Message message) {
                    ...
                    //接收到消息之后进行消息展示处理，这个地方可以处理所有人的消息。

                   /* //例如，从usera发送过来的message,发送给用户1
                    Log.e("TAG","MainActivety");
                    Log.e("type", message.getType().toString());  //chat
                    Log.e("message",message.getBody().toString());
                    Log.e("from",message.getFrom());  //usera@songxitang-pc/Spark
                    Log.e("to",message.getTo());    // 1@songxitang-pc/Smack
                    Log.e("XML",message.toXML().toString());

                    Log.e("Count","Count: "+getChatManager().getChatListeners().size());*/
                }
            });
        }
    };
    ...
    private static class MyHandler extends Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            final String friendNickname = mFriendListAdapter.findNicknameByUsername(friendUsername);
            //如果包含视频通话信息
                ...
                switch (type)
                {
                    case "video-invitation":
                        AlertDialog.Builder builder = new AlertDialog.Builder(mMainActivity)
                                .setTitle("视频聊天")
                                .setIcon(R.drawable.face17)
                                .setMessage(friendNickname + "请求与你视频聊天");
...
//                String friendNickname = mFriendListAdapter.findNicknameByUsername(friendUsername);
